...
<center>	<h2>SOSOSO Buses</h2> </center>
<br>
				<ul class="actions">
					<li>
						<a href="addbus.php" class="button small">Add bus</a>
					</li>
				</ul>
...
//	echo "</td>";
	...
	echo "<td>";
	echo '<a href="editbus.php? Bus_id='.$BusID.'" class="button small">Edit</a>';
	echo "</td>";
	echo "<td>";
	echo '<a href="deletebus.php? Bus_id='.$BusID.'" class="button small">Delete</a>';
	echo "</td>";
	echo "</tr>";
}
echo "</table>";
