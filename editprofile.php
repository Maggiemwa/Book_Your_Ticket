...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Edit Customer detais</title>
...
<center>	<h2>Edit Your datails below</h2> </center>
...
$custID=$_GET['custid'];
$sel="SELECT * FROM user WHERE UserID='$custID'" ;
...
$rows= mysqli_fetch_array($str);
	...
	$sname=$rows['Lname'];
		$uname=$rows['Username'];
	$email=$rows['Email'];
	$number=$rows['mobilenumber'];
echo '<form action="editingprofile.php?custid='.$custID.'" method="POST">';
echo"Firstname";
 echo '<input class="form-control"  type="text" value="'.$fname.'" name="firstname" >
 <br> Surname';
 echo '<input class="form-control" type="text" value="'.$sname.'" name="lastname" >

 <br> Email';
 echo '<input class="form-control" type="text" value="'.$email.'" name="email" ><br>
 <br>Mobile number';
 echo '<input class="form-control" type="text" value="'.$number.'" name="mobilenumber" ><br>
 ';
