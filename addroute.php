...
h2
{
	...
	<body style="background:-webkit-linear-gradient(left top,BurlyWood,Chocolate,Darkkhaki,BlanchedAlmond,BurlyWood); background: linear-gradient(to bottom right,BurlyWood,CadetBlue,Darkkhaki,BlanchedAlmond,BurlyWood);">
		...
		<!-- Main -->
			...
			<form  action="addingroute.php" method="POST">
 ...
 <?php
 include "include.php";
 $resultcat = mysqli_query($connect,"SELECT * FROM District");
...
{?>
 ...
 <?php }?>
  ...
  <br>
  <center><input class="btn btn-primary" type="submit" value="Add" name="addroute"></center>
  </div>
</form>
<br>
