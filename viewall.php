...
<center>	<h2>Bus Schedules</h2> </center>


<?php
include "include.php";
$sel="SELECT * FROM `bus_schedule`ORDER BY `departuredate` ASC" ;
...
//	echo "</td>";
	...
	echo "<td>";
	//echo '<a href="payment1.php?Seats_no='.$Seats.' & Bus_id='.$BusID.'& Total_fare='.$Fare.'">Book Now</a>';
	echo '<a href="book_bus.php?schid='.$schid.' & userid='.$_SESSION['user'].'">Book Now</a>';
	echo "</td>";
	//echo "<td>";
	//echo '<a href="deletebus.php? schid='.$schid.'" class="button small">Delete</a>';
	//echo "</td>";
	echo "</tr>";
}
echo "</table>";
