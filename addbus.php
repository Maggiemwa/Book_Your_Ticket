...
h2
{
	...
	<body style="background:-webkit-linear-gradient(left top,BurlyWood,Chocolate,Darkkhaki,BlanchedAlmond,BurlyWood); background: linear-gradient(to bottom right,BurlyWood,CadetBlue,Darkkhaki,BlanchedAlmond,BurlyWood);">
		...
		<!-- Main -->
			...
			<section class="main">
			<div class="col-auto">
			<form  action="addingbus.php" method="POST" class="form-4" >
			
 	Name
  <input class="form-control" placeholder="Enter bus name" type="text" name="Name" >
  <br>Type
  <input class="form-control" placeholder="Enter a bus type" type="text" name="Type" >
 <br> No of seats
  <input class="form-control" type="text" placeholder="Enter no of seats" name="Seats" >
  <br>
  <br>Make or manufacturer
  <input class="form-control" type="text" placeholder="Enter name of manufacturer" name="manufacturer" >
  <br>
  <br> year of make
  <input class="form-control" type="text" placeholder="Year of make" name="yearmake" >
  <br>
  <br> Bus Type
  <input class="form-control" type="text" placeholder="Enter type of bus" name="bustype" >
  <br>
  <center><input class="btn btn-primary" type="submit" value="Add" name="addbus"></center>
  </div>
  </div>
</form> 
</section>
