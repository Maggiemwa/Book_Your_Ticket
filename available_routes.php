...
<center>	<h2>SOSOSO ROUTES</h2> </center>
<br>
				<ul class="actions">
					<li>
						<a href="addroute.php" class="button small">Add route</a>
					</li>
				</ul>
...
//	echo "</td>";
	//echo "<td>";
	//echo '<a href="view_ticket1.php?id='.$BusID.'">Book bus</a>';
	//echo '<a href="viewbus.php?Bus_id='.$BusID.'" class="button small">View Image</a>';
	//echo "</td>";

	echo "<td>";
	echo '<a href="deleteroute.php? route_id='.$id.'" class="button small">Delete</a>';
	echo "</td>";
	echo "</tr>";
}
echo "</table>";
