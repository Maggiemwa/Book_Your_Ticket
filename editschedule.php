...
<center>	<h2>Edit Bus Schedule</h2> </center>
...
$schID=$_GET['schid'];
$sel="SELECT * FROM bus_schedule WHERE id='$schID'" ;
$str= mysqli_query($connect,$sel);
$rows= mysqli_fetch_array($str);
$name= $rows['busname'];
	$date= $rows['departuredate'];
	$route= $rows['route'];
	$dtime=$rows['departuretime'];
	$atime=$rows['arrivaltime'];
	$fare=$rows['Fare'];
echo '<form action="editingschedule.php?sch_id='.$schID.'" method="POST">';
echo"Bus Name";
 echo '<input class="form-control"  type="text" value="'.$name.'" name="busname" >
 <br> Date of departure';
 echo '<input class="form-control" type="text" value="'.$date.'" name="date" >
 <br> Route';
 echo '<input class="form-control" type="text" value="'.$route.'" name="route" ><br>
 <br> Departure Time';
 echo '<input class="form-control" type="text" value="'.$dtime.'" name="dptime" ><br>
 <br>Estimated Arrival time';
 echo '<input class="form-control" type="text" value="'.$atime.'" name="arrtime" ><br>
 <br> Fare';
 echo '<input class="form-control" type="text" value="'.$fare.'" name="fare" ><br>';
