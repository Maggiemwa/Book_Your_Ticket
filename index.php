...
<html lang="en">
	...
	<body class="landing">
			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="index4.php">Login/Register</a></li>
		...
		<!-- Banner -->
			...
			<section id="banner">
				<h2>Welcome to SOSOSO Bus Ticket Reservation System</h2>
				<p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Bus Booking<br>Brought To You By SOSOSO coaches</p>
				<ul class="actions">
					<li>
		...
		<!-- One -->
		<a name="about"></a>
			<section id="banner2" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>SOSOSO COACHES</h2>
						<p> <b>SOSOSO Bus Ticket Reservation System is an online ticket booking system. <br>You can now choose your bus and your seat easily, have the tickets delivered to your mail and online payments. <br>Try the SOSOSO COACH experience.</b></p>

					</header>
					<div class="row 200%">
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-clock-o"></i>
							<p>You can book tickets a month prior to your departure<br> You can cancel a ticket a day before departure with 100% refund</p>
						</section>
						<section class="4u 12u$(small)">
						...
						<section class="4u$ 12u$(small)">
							...
							<p>Create an account to start the booking process</p>
						</section>
					</div>
					<ul class="actions">
							<li>
								<a href="#" class="button big">BACK TO THE TOP</a>
							</li>
						</ul>
				</div>
			</section>
		...
		<!-- Two -->
			<section id="banner3" class="wrapper style2 align-center">
				<div class="container">
					<header>
						<h2>SOSOSO COACHES</h2>
...
<p><b>Booking Bus Ticket with SOSOSO Bus Ticket Reservation System</b> <br>
	With more than 10 bus routes spread across the country and integration with over 15 bus operators, SOSOSO online bus reservation system is simpler and smarter. It provides you a wide range of facilities, right from choosing your pickup point to your preferred choice of seat (for instance, luxury buses with sleeper berths). You can also choose from the widest range of available buses like Mercedes, Volvo, Volvo AC, AC luxury, Deluxe, Sleeper, Express and other private buses. The payment options are easier too- you can use either debit/credit card facility or net-banking. Not just that, in case of any change in your travel plan, bus tickets can be cancelled online. So, next time you need not stand in long queues or search at different bus ticket counters. You can directly book bus tickets online with SOSOSO and stay assured.</p>
					...
					<footer>
						...
						<p> <b> SAVE BIG ON BUS TICKETS!! GET  INSTANT DISCOUNTS. <BR> COUPON CODE : DISBOOKBUS </b></p>
					</footer>
				</div>
			</section>
		...
		<!-- Footer -->
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
						...
						<ul class="actions">
							<li>
								<a href="#" class="button alt small">To the top</a>
							</li>
						</ul>
					</center>
					</div>
